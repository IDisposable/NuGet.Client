...
namespace NuGet.Protocol
{
    public class DependencyInfoResourceV2Feed : DependencyInfoResource
    {
        ...
        public DependencyInfoResourceV2Feed(HttpSourceResource httpSourceResource, SourceRepository source)
        {
            ...
            _feedParser = new V2FeedParser(httpSourceResource.HttpSource, source.PackageSource);
            _source = source;
        }
